...
//        inicializarIngredientes();
    ...
    /**
     * Inicializa los ingredientes con sus respectivos precios en colones.
     */
//    private HashMap<String, Integer> inicializarIngredientes() {
//        HashMap<String, Integer> ingredientesNuevos = new HashMap<>();
//        ingredientesNuevos.put("Pan de hamburguesa ", 500);
//        ingredientesNuevos.put("Carne de res molida", 1000);
//        ingredientesNuevos.put("Carne de pollo molida", 3000);
//        ingredientesNuevos.put("Sal y pimienta", 250);
//        ingredientesNuevos.put("Queso", 500);
//        ingredientesNuevos.put("Lechuga", 250);
//        ingredientesNuevos.put("Tomate", 250);
//        ingredientesNuevos.put("Cebolla", 250);
//        ingredientesNuevos.put("Pepinillos", 250);
//        ingredientesNuevos.put("Salsa de tomate ", 250);
//        ingredientesNuevos.put("Mostaza", 250);
//        ingredientesNuevos.put("Mayonesa", 250);
//    }
